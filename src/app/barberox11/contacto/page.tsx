...
export default function ContactoBarberox() {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        if (currentStep?.key === "project") formData.current.mensaje = `[BARBEROX] ${value}`;
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-[18%] left-1/2 -translate-x-1/2 w-[500px] h-[200px] bg-[#C5A059]/5 rounded-full blur-[100px] pointer-events-none" />
            ...
            {/* Center content */}
            <div className="relative flex flex-col items-center gap-12 px-4 w-full max-w-3xl">
                ...
                <img
                    ...
                    alt="Barberox"
                    className="w-[220px] md:w-[320px] h-auto object-contain drop-shadow-[0_0_50px_rgba(197,160,89,0.2)]"
                />
                ...
                <div className="min-h-[70px] flex items-center justify-center">
                    ...
                    {isDone && (
                        <div className={`text-center transition-all duration-700 ${phase === "done" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                            ...
                            <a
                                href="/barberox11"
                                className="inline-block mt-8 px-8 py-3 border border-white/10 text-sm text-white/60 hover:text-white hover:border-white/30 transition-all"
                            >
                                Volver al sitio
                            </a>
                        </div>
